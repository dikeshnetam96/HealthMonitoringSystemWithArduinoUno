...
* The original package name 'com.javatpoint.Artifact spring-boot-rest-example' is invalid and this project uses 'com.javatpoint.Artifact.springbootrestexample' instead.
